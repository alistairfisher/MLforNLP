...
public class NBClassifier {
    ...
    static int trainingThreshold = 600;

    static ArrayList<Category> categories = NBTrainer.train(trainingThreshold);
            ...
            while ((line = br.readLine()) != null) {
                    ...
                    for (String word : words) {
                        ...
                        if (NBTrainer.totalCount(normalizedWord)>0) {
                            cumuProb += Math.log10(c.probability(normalizedWord));
                        }
                    }
            }
